        ...
        >
          ...
          <div className="space-y-6">
            ...
            {[...commonFields, ...dynamicFields].map(({ name, type, placeholder, icon, autoComplete }) => (
              <div key={name} className="relative flex items-center border border-theme-input-border rounded-xl px-5 py-3 shadow-sm focus-within:ring-3 focus-within:ring-blue-500/50 focus-within:border-theme-input-border-hover transition-all duration-300 group hover:border-theme-input-border-hover">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  // REMOVED bg-transparent HERE so that bg-theme-input-bg from index.css applies
                  className="w-full outline-none text-theme-text placeholder-theme-input-placeholder text-lg flex-grow"
